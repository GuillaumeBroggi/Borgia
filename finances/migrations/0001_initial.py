...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('register_sharedevent', 'Se préinscrire à un événement commun'), ('list_sharedevent', 'Lister les événements communs'), ('manage_sharedevent', 'Gérer les événements communs'), ('create_sharedevent', 'Créer un événement commun'), ('proceed_payment_sharedevent', 'Procéder au paiement des événements communs')),
            },
        ),
        migrations.CreateModel(
            name='Transfert',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finances.SharedEvent')),
            ],
        ),
        migrations.CreateModel(
            name='Cash',
